...
its largest. Every tail-\emph{shape} metric adds nothing or subtracts. Yet the shape metrics are not broken. On genuinely
...
We are deliberately careful about the \emph{strength} of the
