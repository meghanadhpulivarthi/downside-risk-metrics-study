...
increment by ${\le}0.02$; App.~\ref{app:delisting}). Table~\ref{tab:partials} gives the
...
$0.32$--$0.34$ --- trailing volatility is not screened off, so forward volatility is
...
correction. Power on the thin crypto beds: for VaR, on crypto-16 ($n=8$) and crypto-17 ($n=9$)
